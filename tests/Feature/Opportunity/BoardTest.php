...
it('should render', function () {
    ...
    Livewire::test(Opportunities\Board::class)->assertOk();
...
it('should list all opportunities ordered by status', function () {
    ...
    Livewire::test(Opportunities\Board::class)->assertSet('opportunities', function (Collection $collection) {
        expect($collection)
...
it('should list all opportunities by sort_order', function () {
    ...
    Livewire::test(Opportunities\Board::class)->assertSet(
        'opportunities',
        function (Collection $collection)
        use ($opp1,$opp2, $opp3,$opp4,$opp5) {
            expect($collection)
